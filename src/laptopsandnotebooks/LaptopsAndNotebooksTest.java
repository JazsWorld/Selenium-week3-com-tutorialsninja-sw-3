...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("input-payment-firstname"), "Jagruti");
        sendTextToElement(By.id("input-payment-lastname"), "Jadeja");
        sendTextToElement(By.id("input-payment-email"), "jagrutijadeja1717@gmail.com");
        sendTextToElement(By.id("input-payment-telephone"), "0772562362");
        sendTextToElement(By.id("input-payment-address-1"), "6 Falcon  street");
        sendTextToElement(By.id("input-payment-city"), "Milton keynes");
        sendTextToElement(By.id("input-payment-postcode"), "MK63HH");
